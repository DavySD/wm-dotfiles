...
static const char *fonts[]          = { "VictorMono Nerd Font:style=Semibold:size=10" };
static const char *colors[][3]      = {
                     /* fg         bg         border   */
    [SchemeNorm] = { "#657b83", "#fbf1c7", "#ebdbb2" }, // Estado Normal/Inativo
    [SchemeSel]  = { "#073642", "#ebdbb2", "#268bd2" }, // Estado Selecionado/Ativo
};
typedef struct {
	const char *name;
	const void *cmd;
